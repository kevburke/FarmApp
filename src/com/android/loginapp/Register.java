...
public class Register extends Activity {
	 ...
	 */
	 private void initControls()
	    {
		 	newUsername = (EditText) findViewById(R.id.nUsername); 		//Enter new Username ICBF
		 	newPassword = (EditText) findViewById(R.id.nPassword);		//ICBF password
		 	newConfiPass = (EditText) findViewById(R.id.nConfiPass);	//Confirm same password
     ...
     */
	 ...
	 private void RegisterMe(View v)
	    {
		 	//Get user details. 
	    	String username = newUsername.getText().toString();				//input ICBF username
	    	String password = newPassword.getText().toString();				//input ICBF password
	    	String confirmpassword = newConfiPass.getText().toString();		//input ICBF password
	    	...
	    	if (!password.equals(confirmpassword)) {
	    		Toast.makeText(getApplicationContext(), 
	    				"The password does not match.",
	    					...
	    					newPassword.setText("");					//reset password fields to empty
	    					newConfiPass.setText("");
	    		return;
	    	}
